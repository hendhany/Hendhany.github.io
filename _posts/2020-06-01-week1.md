...
On week 5: we started on using the TriQL and get more familier with it. We explored the database sets provided to see if it had sufficient information to run the queries. We agreed on using the Pokemon data the pilot TriQL.
